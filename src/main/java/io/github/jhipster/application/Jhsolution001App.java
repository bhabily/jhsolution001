...
public class Jhsolution001App {

    private static final Logger log = LoggerFactory.getLogger(Jhsolution001App.class);

    private final Environment env;

    public Jhsolution001App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhsolution001.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jhsolution001App.class);
